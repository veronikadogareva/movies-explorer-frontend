  ...
  return (
    <nav className="navigation">
      <ul className="navigation__container">
        ...
        <li className="navigation__item"><NavLink className={({ isActive }) => `navigation__link ${location.pathname === '/' ? "navigation__link_path_main" : ""} `} to="/saved-movies">Сохранённые фильмы</NavLink></li>
